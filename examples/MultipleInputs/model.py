...
def twinnet():
    tunnel = df.Sequential(
        ...
        #df.SpatialConvolution(1, 32, 5, 5),
        df.SpatialConvolution(1, 32, 5, 5, 1, 1, with_bias=False),
        df.BatchNormalization(32),
        df.ReLU(),
        df.SpatialMaxPooling(2, 2),

        #df.SpatialConvolution(32, 64, 5, 5),
        df.SpatialConvolution(32, 64, 5, 5, 1, 1, with_bias=False),
